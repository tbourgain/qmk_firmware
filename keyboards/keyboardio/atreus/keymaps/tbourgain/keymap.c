...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_LCTL,     KC_LGUI, KC_LALT, LT(_LW, KC_SPC), KC_SPC, MO(_MS), KC_RALT, KC_SPC,  LT(_RS, KC_SPC), KC_MINS, KC_QUOT, KC_ENT ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    QK_LEAD, KC_LGUI,  KC_LALT , KC_LSFT, KC_SPC, KC_LCTL, KC_RALT,KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL ),
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    KC_NO,   KC_VOLD, KC_LALT, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  TO(_QW), KC_PSCR, KC_SCRL, DM_RSTP ),

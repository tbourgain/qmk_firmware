...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_LCTL,     KC_LGUI, KC_LALT, MO(_LW), KC_SPC, KC_LCTL, KC_RALT, KC_SPC,  MO(_RS), KC_MINS, KC_QUOT, KC_ENT ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    QK_LEAD, KC_INS,  KC_LALT, KC_LSFT, KC_BSPC, KC_LCTL, KC_RALT,KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL ),
...
void leader_end_user(void) {
    if (leader_sequence_two_keys(KC_G, KC_M)) {
       ...
       SEND_STRING("sudo -i -r unconfined_r -t unconfined_t");
    } else if (leader_sequence_two_keys(KC_N, KC_R)) {
       SEND_STRING("newrole -r sysadm_r");
